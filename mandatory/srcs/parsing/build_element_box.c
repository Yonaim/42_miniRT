		...
		t_point3 *p_end1, t_point3 *p_end2)
{
	...
	bo_info->xy_rectangle[0].y2 = p_end1->y;
	...
	bo_info->xy_rectangle[1].y2 = p_end1->y;
		...
		t_point3 *p_end1, t_point3 *p_end2)
{
	...
	bo_info->xz_rectangle[0].z2 = p_end1->z;
	...
	bo_info->xz_rectangle[1].z2 = p_end1->z;
		...
		t_point3 *p_end1, t_point3 *p_end2)
{
	...
	bo_info->yz_rectangle[0].z2 = p_end1->z;
	...
	bo_info->yz_rectangle[1].y2 = p_end1->y;
	bo_info->yz_rectangle[1].y2 = p_end2->y;
